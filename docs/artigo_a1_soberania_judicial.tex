...
\author{
    \IEEEauthorblockN{Delvek da S. V. de Sousa}
    \IEEEauthorblockA{
...
O autor agradece \`{a} Universidade Federal do Tocantins (UFT) e ao Laborat\'{o}rio de Computa\c{c}\~{a}o Inteligente (LabCity-LLM) pelo suporte computacional e acad\^{e}mico.
...
D. Sousa, ``Arquitetura LLM para Tribunais --- Sistema e Cria\c{c}\~{a}o,'' Referencial T\'{e}cnico, Universidade Federal do Tocantins, 2025.
